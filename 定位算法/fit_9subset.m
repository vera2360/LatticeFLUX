function fit_locs=fit_9subset(imgbuf,cx,cy,sigmax,sigmay,r,frame)
    ...
    [fit_locs,~,~,exitflag]=lsqcurvefit(@Gaussian9,xstart,x,ff,[],[],options);


end


function f=Gaussian9(xstart,x)
    xd=x(:,1:7);
    yd=x(:,8:14);
